...
\end{equation}
Here the number $g_{n}$ gives the number of quantum mechanical states having energy $E_{n}$.\sidenote{$g_{n}$ is known as the \emph{degeneracy} of a given energy} For energy
\[
