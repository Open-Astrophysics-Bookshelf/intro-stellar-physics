...
If in addition to being in steady-state, the matter and radiation are also in thermal equilibrium,\sidenote{meaning they at the same temperature with each having a thermal distribution of states} so that $J_{\nu} = B_{\nu}$, then eq.~(\ref{e.rad-equil}) implies that
