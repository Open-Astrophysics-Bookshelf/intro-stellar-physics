...
Imagine a small cube with sides of length $\lambda$ and filled with photons. The total radiant energy in the cube is $\Delta E$. In a time $\Delta t = \lambda/c$, all of the energy will leave this cube. The total luminosity is $\Delta E/\Delta t = c\Delta E/\lambda$. If everything is isotropic, then the flux out of any one face is $1/6$ of the luminosity, divided by the area of that face:
\[
	F = \frac{1}{6\lambda^{2}}\frac{c\Delta E}{\lambda} = \frac{1}{6}c U,
\]
where $U = E/\lambda^{3}$ is the radiative energy density.
