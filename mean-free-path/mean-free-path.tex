...
Thus, if your system has $\tau_{\nu}\ll 1$, then photons are hardly affected by the matter and we say the system is nearly transparent; if, on the other hand, $\tau_{\nu} \gg 1$, then photons cannot go through the system and we say that the system is opaque.
