...
This result is known as \newterm{Wien's law}. Check this: what is the peak wavelength of the sun's emission?  
\end{exercisebox}
...
\newthought{We can also compare the flux from two different filters for the same star.} The difference in magnitudes for two different filters defines a \emph{color index}, which is a measure of the star's spectrum (and, roughly, its temperature). For example,
\[
