...
The equation of state becomes dominated by radiation roughly where $P(\textrm{ideal gas}) = P(\textrm{radiation})$. From this, derive a relation between $\log(T)$ and $\log(\rho)$. Plot this relation on the figure for exercise~\ref{ex.contraction-to-main-sequence}, and indicate which side of this relation is radiation-pressure dominated. What do your findings in this exercise imply for the mass range of main-sequence stars?
\end{exercisebox}
