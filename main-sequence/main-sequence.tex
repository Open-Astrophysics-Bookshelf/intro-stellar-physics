...
We now have almost all of the physics necessary to describe the life of a star. We need two additional items: we must consider whether the fluid is at rest or whether there is circulation, and we must discuss departures from the classical ideal gas equation of state. Changes in the equation of state are important for low-mass stars and set the minimum stellar mass.
...
\end{equation}
To these we add the equation for the temperature,
